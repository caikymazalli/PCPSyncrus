...
<nav class="sidebar" id="sidebar">
  ...
  <div style="padding:12px 0;">
    ...
    <a href="/exportacao" class="nav-item ${activePage === 'exportacao' ? 'active' : ''}" title="Exportação — Clientes Internacionais e Invoices">
      <span class="icon"><i class="fas fa-globe-americas"></i></span> Exportação
    </a>
    <a href="/roteirizacao" class="nav-item ${activePage === 'roteirizacao' ? 'active' : ''}" title="Roteirização — Gestão de Rotas e Entregas">
      <span class="icon"><i class="fas fa-route"></i></span> Roteirização
    </a>
